...
plot_data <- data.frame(
  group = c("Docker", "Linux", "Web-3", "Log"),
  ReBase = c(20.0902, 64.7865, 29.3724, 51.1359),     # TODO: replace with your data
  Ideal = c(20.1312, 67.3458, 30.1967, 57.2712),       # TODO: replace with your data
  check.names = FALSE
)

method_labels <- c("ReBase", "Ideal")
method_colors <- c(
  "ReBase" = "#A61D24",
  "Ideal" = "#78B0B8"
)
...
create_three_method_barplot <- function(
    ...
    group_col = "group",
    method_labels = c("ReBase", "Ideal"),
    fill_colors = c("ReBase" = "#A61D24", "Ideal" = "#78B0B8"),
    x_label = "",
    y_label = "Value",
    axis_text_size = 50,
    axis_title_size = 50,
