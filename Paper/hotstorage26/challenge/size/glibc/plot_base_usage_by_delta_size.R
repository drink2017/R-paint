...
csv_file <- "C1_M14_glibc_R0_T64_delta_base_usage.csv"
output_file <- "C1_M14_glibc_R0_T64_delta_base_usage.pdf"
...
write.csv(summary_df, "C1_M14_glibc_R0_T64_delta_base_usage_summary.csv", row.names = FALSE)
